...
// 2. 정식 문법
// ⭐️alphabetArray.replaceSubrange(0...2, with: ["x", "y", "z"])
...
// 2.fallthrough문
// 어떤 case를 실행하고 그 다음 case의 일치 여부를 따지지 않고 하위 case를 동작시키는 것


// 3.continue문
// (가장 가까운) 반복문 주기로 돌아가 반복의 다음 주기를 실행함
...
// 3번 방법
// 옵셔널 바인딩
// if let optA = optionalA { ... }

// guard let optA = optionalA else {...} ...
...
// ⭐️⭐️⭐️ 아래 스위치문을 작성해서, 이메일과 비밀번호를 출력하는 코드를 완성하세요.
